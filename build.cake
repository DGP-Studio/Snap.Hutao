    ...
    .Does(() =>
{
    ...
    if (AzurePipelines.IsRunningOnAzurePipelines || GitHubActions.IsRunningOnGitHubActions)
    {
        ...
        content = System.Text.RegularExpressions.Regex.Replace(content, "  Publisher=\"([^\"]*)\"", "  Publisher=\"E=admin@dgp-studio.cn, CN=DGP Studio, OU=Dev, O=DGP Studio, L=San Jose, S=CA, C=US\"");
