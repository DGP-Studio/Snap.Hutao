...
internal partial class StructUsingCustomDbProperty<T> : DbProperty<T>
    where T : struct
{
    ...
    public StructUsingCustomDbProperty(IServiceProvider serviceProvider, string key, Func<T> defaultValueFactory, Func<string, T> from, Func<T, string> to)
    {
    ...
    public StructUsingCustomDbProperty(IServiceProvider serviceProvider, string key, T defaultValue, Func<string, T> from, Func<T, string> to)
