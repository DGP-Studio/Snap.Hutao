...
{
    private static ReadOnlySpan<byte> InitialVector { get => [0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF]; }
    ...
    public static string Decode(string data, out string address)
    {
        ...
        using (DES des = DES.Create())
        {
            ...
            return Encoding.UTF8.GetString(des.DecryptCbc(Convert.FromBase64String(data), InitialVector));
        }
    }
}