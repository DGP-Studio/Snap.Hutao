...
internal static class KnownLaunchSchemes
{
    ...
    private static readonly LaunchScheme ServerChineseChannelBilibiliSubChannelNoTapTapCompat = new LaunchSchemeBilibili(SubChannelType.NoTapTap, false);
    ...
    private static readonly LaunchScheme ServerGlobalChannelBilibiliSubChannelDefaultCompat = new LaunchSchemeOversea(ChannelType.Bili, SubChannelType.Default, false);
    ...
    [
        ...
        ServerChineseChannelBilibiliSubChannelNoTapTapCompat,
        ...
        ServerGlobalChannelBilibiliSubChannelDefaultCompat,
