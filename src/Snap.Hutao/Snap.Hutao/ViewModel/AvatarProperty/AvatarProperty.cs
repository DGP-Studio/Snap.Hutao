...
internal sealed class AvatarProperty : ObservableObject, INameIcon
{
    ...
    [
        ...
        KeyValuePair.Create(FightProperty.FIGHT_PROP_ELEC_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Electric.png").ToUri()),
        KeyValuePair.Create(FightProperty.FIGHT_PROP_FIRE_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Fire.png").ToUri()),
        KeyValuePair.Create(FightProperty.FIGHT_PROP_GRASS_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Grass.png").ToUri()),
        KeyValuePair.Create(FightProperty.FIGHT_PROP_ICE_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Ice.png").ToUri()),
        KeyValuePair.Create(FightProperty.FIGHT_PROP_ROCK_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Rock.png").ToUri()),
        KeyValuePair.Create(FightProperty.FIGHT_PROP_WATER_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Water.png").ToUri()),
        KeyValuePair.Create(FightProperty.FIGHT_PROP_WIND_ADD_HURT, StaticResourcesEndpoints.StaticRaw("Property", "UI_Icon_Element_Wind.png").ToUri()),
