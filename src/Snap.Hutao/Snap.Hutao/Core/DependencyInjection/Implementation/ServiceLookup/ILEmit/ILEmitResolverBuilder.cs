...
internal sealed class ILEmitResolverBuilder : CallSiteVisitor<ILEmitResolverBuilderContext, object?>
{
    ...
    public ILEmitResolverBuilder(ServiceProvider serviceProvider)
    {
        ...
        scopeResolverCache = [];
        buildTypeDelegate = (key, cs) => BuildTypeNoCache(cs);
    }
    ...
    {
        ServiceIdentifier id = key.ServiceIdentifier;
    ...
    {
        ILEmitResolverBuilderContext context = new(generator)
        {
            Constants = null,
            Factories = null,
        };
    ...
    private GeneratedMethod BuildTypeNoCache(ServiceCallSite callSite)
    {
        ...
        DynamicMethod dynamicMethod = new(
            ...
            parameterTypes:
            [typeof(ILEmitResolverBuilderRuntimeContext), typeof(ServiceProviderEngineScope)],
            owner: GetType(),
            skipVisibility: true);
    ...
    private sealed class ILEmitResolverBuilderRuntimeContext
    {
        ...
        public Func<IServiceProvider, object>[]? Factories { get; set; }
    }
}